//importing Module js
import {shoppingCost, addToCart, totalProce, totalQuantity, cart} from './shoppingCart.js';
...
const jons = new Person('Bipin');
console.log("Bipin" ?? null)
console.log(cart.find(el => el.quantity >= 2));

Promise.resolve("Piyush").then(el => console.log(el));
