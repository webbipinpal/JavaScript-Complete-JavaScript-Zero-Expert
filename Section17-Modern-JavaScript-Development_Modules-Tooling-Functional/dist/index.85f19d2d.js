 ...
 */function(t,n){if(n)return t.slice();var r=t.length,e=a?a(r):new t.constructor(r);return t.copy(e),e}});const c=[],l=function(t,n){c.push({product:t,quantity:n}),console.log(`${n} ${t} add to your cart`)};var s=/**
 * @license
 ...
 */function(){var t=this.__wrapped__.value(),n=this.__dir__,r=Q(t),e=n<0,i=r?t.length:0,o=f8(0,i,this.__views__),u=o.start,a=o.end,f=a-u,c=e?a:u-1,l=this.__iteratees__,s=l.length,p=0,h=f6(f,this.__takeCount__);if(!r||!e&&i==f&&h==f)return aw(t,this.__actions__);var v=[];t:for(;f--&&p<h;){for(var d=-1,g=t[c+=n];++d<s;){var y=l[d],_=y.iteratee,b=y.type,m=_(g);if(2==b)g=m;else if(!m){if(1==b)continue t;break t}}v[p++]=g}return v},iB.prototype.at=ax.at,iB.prototype.chain=ax.wrapperChain,iB.prototype.commit=ax.commit,iB.prototype.next=ax.next,iB.prototype.plant=ax.plant,iB.prototype.reverse=ax.reverse,iB.prototype.toJSON=iB.prototype.valueOf=iB.prototype.value=ax.value,iB.prototype.first=iB.prototype.head,ct&&(iB.prototype[ct]=ax.toIterator),// import * as shopping from './shoppingCart.js';
// console.log(shopping.shoppingCost)
console.log("Importing Module js"),console.log(123),l("Apple",5),l("Apple",5),l("Apple",5),console.log(234,23),console.log(c);const ci={cart:[{product:"Apple",auantity:5},{product:"Pizza",auantity:5}],user:{loggedIn:!0}},co=Object.assign({},ci);console.log(co);const cu=iB(ci);ci.user.loggedIn=!1,console.log(cu);//# sourceMappingURL=index.85f19d2d.js.map

//# sourceMappingURL=index.85f19d2d.js.map
